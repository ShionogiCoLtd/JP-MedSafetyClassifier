...
app = Dash(external_stylesheets=[dbc.themes.FLATLY], prevent_initial_callbacks=True)
...
def load_file(csv_file_name, list_of_contents, list_of_names,
...
@app.callback(
        ...
        inputs=dict(
            ...
            scores_predicted=Input('scores_predicted', 'data'),
